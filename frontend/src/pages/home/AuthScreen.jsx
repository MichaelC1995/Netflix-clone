        ...
        <div className='hero-bg relative'>
                ...
                <div className={"flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2"}>
                    ...
                    <div className={"flex-1 text-center md:text-left"}>
                        ...
                        <p className={"text-lg md:text-xl"}>
                            Watch on Smart TVs, PlayStation, Xbox, Chromecast, AppleTV, Blu-ray players, and more.
                        </p>
                    </div>
                    {/*right side*/}
            ...
            <div className='py-10 bg-black text-white'>
                <div
                    ...
                    <div className={"flex-1 md:text-left text-center"}>
                        <h2 className={"text-4xl md:text-5xl font-extrabold mb-4 text-balance"}>Download your shows to
                            watch offline</h2>
                        <p className={"text-lg md:text-xl"}>Save your favorites easily and always have something to
                            watch.</p>
                    </div>
                </div>
            </div>
            ...
            <div className={"py-10 bg-black text-white"}>
                <div className={"flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2"}>
                    {/*left side*/}
                    <div className={"flex-1 text-center md:text-left"}>
                        <h2 className={"text-4xl md:text-5xl font-extrabold mb-4 text-balance"}>Watch Everywhere</h2>
                        <p className={"text-lg md:text-xl"}>
                    ...
                    <div className={"flex-1 relative overflow-hidden"}>
                        ...
                        <video
                            className="absolute top-8 left-1/2 -translate-x-1/2 h-4/6 z-10 max-w-[63%]"
                            playsInline
                            autoPlay
                            loop
                            muted
